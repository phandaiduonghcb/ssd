...
# TODO(augmented_face_dataset): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(augmented_face_dataset): BibTeX citation
_CITATION = """
"""
CLASS_DICT = {
  'face' : 0,
}
DATASET_PATH = '/dl/ssd/datasets/augmented_face_data'
...
class AugmentedFaceDataset(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for augmented_face_dataset dataset."""
  path = DATASET_PATH
